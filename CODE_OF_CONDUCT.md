...
Report a possible violation privately to `hello@sylin.org` with “Tezuri conduct” in the subject.
The project maintainer will review available messages or other evidence and may ask involved people
for context. Reports and enforcement are handled privately to the extent possible, prioritizing the
safety and confidentiality of affected people. Do not use a public issue for a conduct report.

## Addressing and Repairing Harm

If the maintainer finds that this Code of Conduct has been violated, the following ladder may guide
a proportionate response. Severe incidents may skip lower steps.

1. **Warning:** a private written warning, clarification of expectations, and an appropriate repair
   such as an apology or acknowledgement of responsibility.
2. **Temporarily limited activities:** a time-limited cooldown from particular channels or
   interactions, with clear conditions for return.
3. **Temporary suspension:** removal from community spaces for a defined period, with conditions
   for return and reintegration.
4. **Permanent ban:** removal from all project community spaces when repeated or severe harm cannot
   be safely repaired through lesser measures.

This ladder is a guideline. The maintainer may use discretion based on impact, safety, context, and
the best interests of the community. No one will adjudicate a report in which they are the accused;
in that case, an independent trusted moderator will be asked to handle it.

## Scope

This Code of Conduct applies within all project community spaces and when an individual officially
represents the project in public or other spaces, such as through an official address or account.
...
[CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). The enforcement ladder was inspired
