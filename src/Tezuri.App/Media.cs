...
/// <summary>
/// Article-owned images: ingest, verify, deduplicate, serve.
/// </summary>
...
public sealed record MediaAssetReceipt(
    string ArticleId,
    ...
    AtomicFileWriter writer)
{
    ...
    public Task<MediaAssetReceipt> IngestAsync(
        string articleId,
        string originalFileName,
    ...
    private async Task<MediaAssetReceipt> IngestOwnedStreamAsync(
        Stream content,
        string articleId,
        string originalFileName,
    ...
    private async Task<MediaAssetReceipt> IngestStreamAsync(
        string articleId,
        string originalFileName,
        Stream content,
        CancellationToken cancellationToken)
    ...
    private static MediaAssetReceipt CreateReceipt(
        string articleId,
        string originalFileName,
...
public sealed class MediaController(ArticleMediaStore media) : ControllerBase
{
    ...
    [ProducesResponseType<MediaAssetReceipt>(StatusCodes.Status200OK)]
    [ProducesResponseType<MediaAssetReceipt>(StatusCodes.Status201Created)]
    [ProducesResponseType<ProblemDetails>(StatusCodes.Status400BadRequest)]
    [ProducesResponseType<ProblemDetails>(StatusCodes.Status404NotFound)]
